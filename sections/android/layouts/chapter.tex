...
\begin{figure}[h]
	\begin{center}
		\includegraphics[width=0.4\linewidth]{table_layout.png}
...
layout (\texttt{activity\_main.xml}) og en activity (\texttt{MainActivity.java}). Hvis vi ikke 
har ændret i vores Activity, men blot bruger den Activity som Android Studio 
har lavet til os, vil koden se ud som i \autoref{lst:main-activity}.
