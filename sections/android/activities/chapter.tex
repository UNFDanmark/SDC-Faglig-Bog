...
Vi kan sende en besked med vores itent ved at benytte putExtra metoden der tager en nøgle og en værdi som input.
...
For at få fat i den besked vi sender med vha putExtra kan vi benytte getIntent fra den activity der bliver startet med vores intent. Vi kan få fat i værdien i beskeden med intent.get(Type)Extra(key) hvor "(Type)" skal udskiftes med typen på den værdi man vil have fat i.
...
Vi vil genbruge e-mail-eksemplet. Hvis vi ønsker at sende en email fra vores app, bruger vi handlingen Intent.ACTION\_SEND. Handlingen ACTION\_SEND betyder, at vi vil sende nogle data.
...
Din app kan sende en intent som en broadcast, og Android-systemet sender hele tiden broadcasts. For at modtage en sådan broadcast har du brug for en BroadcastReceiver-klasse, som kan se sådan ud:
