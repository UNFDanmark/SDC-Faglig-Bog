...
\begin{example}
    ...
    Men hvad med ting som titel, genre, formatter, eller udgivelsesdato? \todo{Mere her!!}
...
\begin{exercise}
    \todo{Opgave om at klassifiere koncepter i klasser og specifikke objekter.}
\end{exercise}
...
\todo{Flyt længere ned. Ikke utrolig vigtig for SDC. Feltvariabler og metoder er vigtigere.}
...
ArrayLister kun skal have en. \marginnote{Ved en faktisk
implementation ville man nok bruge en anden type til et telefonnummer
for at sikre at der er 8 cifre}Dette er fordi, Hashmaps både skal
...
En sidste bemærkning er at der kun kan være en variabel for hver
