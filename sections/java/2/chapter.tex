...
\section{Løkker}
	...
	\subsection{Continue}
		...
		\begin{JavaCode}{Kode der anvender \texttt{continue} til at kun vise de lige tal.}{lst:unknown-a}
			for (int i = 1; i <= 10; i++) {
				if (i % 2 == 0)  continue;
...
\section{Funktioner}
    ...
    \subsection{!Extra! Call-by-reference}
        ...
        \begin{JavaCode}{Call-by-reference demonsteret. Læg mærke til at når \texttt{f} ændrer i værdien af \texttt{a}, så ændrer den også i værdien af \texttt{num}. Dette er fordi at \texttt{num} og \texttt{a} er de samme objekter i dette tilfælde.}{lst:call-by-value-example}
            public class Num {
                public int inner;
	...
	\subsection{!Extra! Rekursion}
        ...
        \begin{exercise}
            Fibonnaci sekvensen er en liste af tal \newline (\(1, 1, 2, 3, 5,
