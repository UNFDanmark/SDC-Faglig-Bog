...
\section{Funktioner}
	...
	\subsection{Procedurer: Funktioner uden retur-værdier}
        ...
        Du husker nok \JavaInline{main} og dens underlige
        \JavaInline{void} retur-type. \JavaInline{void} er den
        retur-type man giver til funktioner som ikke burde give et
        resultat. Det giver god mening at \JavaInline{main} har denne
        type, da der ikke er noget vi kan give tilbage til hvadend der
        kaldte \JavaInline{main}.
        ...
        \todo{Giv eksempel på en void funktion.}

        \todo{Lav en enkelt opgave.}
