...
\section{Funktioner}
	...
	Vi er ofte interesseret i at \emph{enkapsulere} noget kode i såkaldt
	\emph{funktioner}\footnote{Også kaldet \emph{metoder} eller \emph{procedurer}.},
	for at kunne gentage arbejde på en anderledes måde end løkker tillader os.
